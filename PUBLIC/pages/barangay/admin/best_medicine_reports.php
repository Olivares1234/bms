...
<?php include(SHARED_PATH . '/barangay/admin/reports/best_medicine_reports/best_medicine_header.php'); ?>
...
<?php include(SHARED_PATH . '/barangay/admin/reports/best_medicine_reports/best_medicine_footer.php'); ?>