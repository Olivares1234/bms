...
<?php include(SHARED_PATH . '/barangay/admin/reports/best_beneficiary_reports/best_beneficiary_header.php'); ?>
	...
	<div class="container">
		...
		<div class="card px-3 pt-2 pb-3 mt-4 shadow-nohover">
			<div class="float-right mt-4">
				<select @change="retrieveBestBeneficiary(select_reports)" v-model="select_reports" id="select_reports" class="form-control form-control-sm d-inline-block col-md-2 float-right" id="show_entries">
...
<?php include(SHARED_PATH . '/barangay/admin/reports/best_beneficiary_reports/best_beneficiary_footer.php'); ?>