...
<?php include(SHARED_PATH . '/city_hall/pharmacist/medicine/returned_medicine/returned_medicine_header.php'); ?>
			...
			<div class="mt-1">
				...
				<nav aria-label="Page navigation example">
					<ul class="pagination justify-content-end">
				    	...
				    	<li class="page-item">
				    		<a class="page-link btn btn-sm bg-primary text-light py-1 px-2" v-for="num in Math.ceil(this.returned_medicines.length / this.show_entries) > 3 ? 3 : Math.ceil(this.returned_medicines.length / this.show_entries)" @click="pagination(num)" style="display: inline-block">{{num}}
				    		</a>
				    	</li>
				    	<li class="page-item">
...
<?php include(SHARED_PATH . '/city_hall/pharmacist/medicine/returned_medicine/returned_medicine_footer.php'); ?>