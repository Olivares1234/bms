...
<?php include(SHARED_PATH . '/city_hall/admin/barangay_request/barangay_request_header.php'); ?>
				...
				<table class="table table-hover table-bordered text-center">		
					...
					<tbody v-if="request_details.length > 0">
						<tr v-for="(request_detail, index) in request_details" v-cloak> 
							...
							<td>
						        <button  @click="deliverModal(request_detail.supplier_medicine_id, request_detail.delivered_quantity)" class="btn bg-success btn-sm" :disabled="request_detail.no_stock || request_detail.delivered_quantity > 0"><i class="fas fa-plus text-light"></i>
						        </button>
							</td>
						</tr>
					</tbody>
...
<?php include(SHARED_PATH . '/city_hall/admin/barangay_request/barangay_request_footer.php'); ?>
