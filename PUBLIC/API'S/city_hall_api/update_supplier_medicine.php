<?php
	...
	if(empty($data['category_id'])) {
		$response['supplier_medicine_category_id_error'] = true;
		$response['status'] = "NOT_OK";
	}

	if(empty($data['unit_category_id'])) {
		$response['supplier_medicine_unit_id_error'] = true;
		$response['status'] = "NOT_OK";
	}
	...
	if(empty($data['supplier_id'])) {
		$response['supplier_id_error'] = true;
		$response['status'] = "NOT_OK";
	} else {
		...
		$supplier_medicine->supplier_medicine_id = $data['supplier_medicine_id'];
		...
		$supplier_medicine->updateSupplierMedicine();
	}