  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="bg-light border-right position-fixed" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        ...
        <a href="<?php echo url_for('pages/city_hall/registration_staff/beneficiary.php')?>" class="list-group-item list-group-item-action bg-light text-dark font-weight-bold"><i class="fas fa-users">&nbsp;</i> Beneficiary</a>

        <a href="<?php echo url_for('pages/city_hall/registration_staff/dependent.php')?>" class="list-group-item list-group-item-action bg-light text-dark font-weight-bold"><i class="fas fa-users">&nbsp;</i> Dependent</a>

        <a href="<?php echo url_for('pages/city_hall/registration_staff/transfer.php')?>" class="list-group-item list-group-item-action bg-light text-dark font-weight-bold"><i class="fas fa-exchange-alt">&nbsp;</i> Transfer Beneficiary</a>
      </div>
    </div>
    <!-- /#sidebar-wrapper -->
