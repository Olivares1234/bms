...
<footer class="page-footer font-small special-color-dark bg-light pt-4 mt-5">
  ...
  <script src="../../../js/city_hall/pharmacist/unavailable_medicine.js?v=<?php echo time(); ?>"></script>
