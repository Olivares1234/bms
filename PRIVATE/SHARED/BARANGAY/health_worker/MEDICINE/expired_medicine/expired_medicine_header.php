  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="bg-light border-right position-fixed" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        <a href="<?php echo url_for('pages/barangay/health_worker/dashboard.php')?>" class="list-group-item list-group-item-action bg-light text-dark font-weight-bold">
          <i class="fas fa-tachometer-alt"></i> Dashboard
        </a>

        <a href="<?php echo url_for('pages/barangay/health_worker/beneficiary.php')?>" class="list-group-item list-group-item-action bg-light text-dark font-weight-bold">
          <i class="fas fa-user-friends"></i> Beneficiary
        </a>
          ...
          <a href="#medicineSubMenu" data-toggle="collapse" aria-expanded="false" class="list-group-item list-group-item-action bg-light text-dark dropdown-container font-weight-bold">
            ...
            <ul class="collapse list-unstyled" id="medicineSubMenu">
              <li class="list-group-item">
                <a href="<?php echo url_for('pages/barangay/health_worker/available_medicine.php')?>" class="dropdown-item bg-light text-dark font-weight-bold">Available Medicine
                </a>
              </li>

              <li class="list-group-item">
                <a href="<?php echo url_for('pages/barangay/health_worker/unavailable_medicine.php')?>" class="dropdown-item bg-light text-dark font-weight-bold">Unavailable Medicine
                </a>
              </li>

              <li class="list-group-item">
                <a href="<?php echo url_for('pages/barangay/health_worker/expired_medicine.php')?>" class="dropdown-item bg-light text-dark font-weight-bold">Expired Medicine
                </a>
              </li>

              <li class="list-group-item">
                <a href="<?php echo url_for('pages/barangay/health_worker/returned_medicine.php')?>" class="dropdown-item bg-light text-dark font-weight-bold">Returned Medicine
                </a>
              </li>
            </ul>
        </li>       

        <a href="<?php echo url_for('pages/barangay/health_worker/referral.php')?>" class="list-group-item list-group-item-action bg-light text-dark font-weight-bold">
          <i class="fas fa-cart-plus">&nbsp;</i> Request Referral
        </a>

        <a href="<?php echo url_for('pages/barangay/health_worker/received_order.php')?>" class="list-group-item list-group-item-action bg-light text-dark font-weight-bold">
          <i class="fas fa-cart-plus">&nbsp;</i> Received Order
        </a>

        <a href="<?php echo url_for('pages/barangay/health_worker/return_medicine.php')?>" class="list-group-item list-group-item-action bg-light text-dark font-weight-bold">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ml-auto mt-2 mt-lg-0">
            <li class="nav-item active">
              <a class="nav-link text-light" href="<?php echo url_for('pages/barangay/health_worker/dashboard.php')?>"><i class="fas fa-tachometer-alt"></i> Dashboard
              </a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                <a class="dropdown-item" href="<?php echo url_for('pages/barangay/health_worker/profile.php')?>">See Profile
                </a>
